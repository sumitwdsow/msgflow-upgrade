...
import { MessageSquare, Mail, Lock, User, Phone, ArrowRight, Eye, EyeOff, CheckCircle } from "lucide-react";
...
const Signup = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Demo only - redirect to external signup
    window.location.href = "https://msgflow.in/register";
  };

  const features = [
    "Free 500 messages to get started",
      ...
      <div className="hidden lg:flex flex-1 hero-gradient items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-xl text-white/70 mb-8">
            Join 500+ businesses already using MsgFlow to reach their customers.
          </p>
          ...
          <div className="mt-12 glass-card rounded-xl p-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-white/60 text-sm">RetailPro India</div>
              </div>
            </div>
          </div>
        </div>
